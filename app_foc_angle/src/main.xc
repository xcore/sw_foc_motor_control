...
void xscope_user_init()
{
	xscope_register( 18
		...
		,XSCOPE_CONTINUOUS, "tdAn0", XSCOPE_INT , "n"
		,XSCOPE_CONTINUOUS, "tdAn1", XSCOPE_INT , "n"
		,XSCOPE_CONTINUOUS, "scAn1", XSCOPE_INT , "n"
		,XSCOPE_CONTINUOUS, "edAn1", XSCOPE_INT , "n"
		,XSCOPE_CONTINUOUS, "tSpn0", XSCOPE_INT , "n"
		,XSCOPE_CONTINUOUS, "tSpn1", XSCOPE_INT , "n"
		...
		,XSCOPE_CONTINUOUS, "odAn0", XSCOPE_INT , "n"
		,XSCOPE_CONTINUOUS, "odAn1", XSCOPE_INT , "n"
/*
