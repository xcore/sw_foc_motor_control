...
/*****************************************************************************/
static void init_pace_component( // Initialise ADC Test data for 'Pacing' test vector component
	VECT_COMP_TYP &vect_comp_s, // Reference to structure of common data for one test vector component
	int inp_states, // No. of states for this test vector component
	const char inp_name[] // input name for current test vector component
)
// See PACE_ADC_ENUM in test_adc_common.h for explanation
{
	...
	safestrcpy( vect_comp_s.state_names[SUM_ON].str ," Pace_On" );
	safestrcpy( vect_comp_s.state_names[NO_SUM].str ," No_Pace" );
