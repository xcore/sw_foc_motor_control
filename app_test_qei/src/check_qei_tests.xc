...
#ifdef MB // Depreciated
{
	...
	acquire_lock(); // Acquire Display Mutex
	printstr( time_str ); printint( chk_data_s.time ); 
	printstr( chk_data_s.padstr2 );
}
#endif //MB
