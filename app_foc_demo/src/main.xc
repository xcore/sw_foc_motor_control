...
{
	xscope_register( 12
		,XSCOPE_CONTINUOUS, "tarId", XSCOPE_INT , "n"
		,XSCOPE_CONTINUOUS, "setVd", XSCOPE_INT , "n"
		,XSCOPE_CONTINUOUS, "mIq_0", XSCOPE_INT , "n"
		,XSCOPE_CONTINUOUS, "reqVq", XSCOPE_INT , "n"
		,XSCOPE_CONTINUOUS, "mVel0", XSCOPE_INT , "n"
		,XSCOPE_CONTINUOUS, "difAn", XSCOPE_INT , "n"
		,XSCOPE_CONTINUOUS, "rVel0", XSCOPE_INT , "n"
