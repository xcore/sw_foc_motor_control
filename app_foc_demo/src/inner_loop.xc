...
// if (motor_s.xscope) xscope_probe_data( 3 ,(-alpha_meas * 17) );
// if (motor_s.xscope) xscope_probe_data( 4 ,(-beta_meas * 17) );
...
//	if (motor_s.xscope) xscope_probe_data( 5 ,h_abs );
	if (h_abs > 0)
	{
...
// if (motor_s.xscope) xscope_probe_data( 4 ,eficny );
} // MB~
