...
)
{
	 ...
	 */
//MB~		WD_GUARD_TYP guard_prot_s = { { 1 ,1 } ,2 }; // Structure of guard data, contains motor protection data
WD_GUARD_TYP guard_prot_s = { { 1 ,0 } ,1 }; // Structure of guard data, contains motor protection data
